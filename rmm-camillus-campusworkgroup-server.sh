...
agentDL='https://agents.tacticalrmm.com/api/v2/agents/?version=2.8.0&arch=amd64&token=1a6ad859-9d8a-40d0-96d8-2477ba69b8cd&plat=linux&api=api.camillus.org'
meshDL='https://mesh.camillus.org/meshagents?id=KtxOIwXxuxhM@5RwZJ4OsU9i4y$Nsjb6Li0nVjmVqO06$pgmdNIP1061@cWWbEoo&installflags=2&meshinstall=6'

apiURL='https://api.camillus.org'
token='af3771c457ea1b941327b838ea65fa8bcafc36a11c6753d53a747239f9b388ae'
clientID='1'
siteID='13'
agentType='server'
proxy=''
